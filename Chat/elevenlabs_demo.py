...
TEXT = """Hi, how are you doing? I'm Booster Robotics T1."""

#你好呀，欢迎来到 Vesta technology！有什么可以帮到你的吗？我很乐意帮您挑选最适合您厨房的抽油烟机！为了给您提供最合适的建议，我需要了解您的具体需求和厨房布局。
#让我问你几个问题：您的烹饪空间属于哪种类型？是在公寓（可能存在通风限制）、独立式住宅还是开放式厨房
